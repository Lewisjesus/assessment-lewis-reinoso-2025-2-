...
subnet_1a_cidr    = "100.95.24.128/28"
...
subnet_1b_cidr    = "100.95.24.144/28"
...
# Route Configuration
route_cidr_block = "172.18.164.224/28"
...
# Lambda layers
cx_oracle_arn = "arn:aws:lambda:us-east-1:241533131297:layer:oracledb:1"
instaclient_layer = "arn:aws:lambda:us-east-1:241533131297:layer:instaclient_layer:1"
boto3_arn = "arn:aws:lambda:us-east-1:241533131297:layer:boto3:1"
cryptography = "arn:aws:lambda:us-east-1:241533131297:layer:cryptography:1"
requests = "arn:aws:lambda:us-east-1:241533131297:layer:requests:1"
pyjwt = "arn:aws:lambda:us-east-1:241533131297:layer:pyJWT_layer:1"
jwt = "arn:aws:lambda:us-east-1:241533131297:layer:jwt_layer:1"
...
# ######################################################################
# terraform.tfvars
#["100.95.24.128/28", "100.95.24.16/28", "172.27.6.0/26"]
# VPC Endpoints CIDR blocks
dynamodb_vpc_endpoints       = ["172.18.164.224/28"]
s3_vpc_endpoints             = ["100.95.24.128/28", "100.95.24.16/28"]
sqs_vpc_endpoints            = ["100.95.24.128/28", "100.95.24.16/28"]
kms_vpc_endpoints            = ["100.95.24.128/28", "100.95.24.16/28"]
secretsmanager_vpc_endpoints = ["100.95.24.128/25"]
oci_endpoints                = ["10.31.192.0/22"]
...
db_secret_username = "API_D1"
db_secret_password = "K2m5H764*v9T1h0D2P*4l2G3q1A"
db_secret_host     = "172.18.164.234"
db_secret_port     = 1521
db_secret_service_name = "pdbbct.koba.int"
